...
If the `rag_search` tool returns "No relevant information found in the project documents for this query.", you MUST answer with exactly the phrase: "No relevant chunks found". Do not add any other text, apologies, or explanations. Just "No relevant chunks found".
"""
